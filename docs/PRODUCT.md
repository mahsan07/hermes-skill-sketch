...
Sketch is a focused, shareable agent workflow.

## What it does

Create throwaway HTML mockups with two or three design variants for comparison. Use when the user explicitly requests this capability or a closely related task.
